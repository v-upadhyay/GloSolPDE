...
slack_constraint(model, terminal_state, lambda, gamma, control_params, slack, states_sampled, uncert, num_samples)
...
control_constraints(model, control_params, uncert, num_params, control_bounds, time_samples, time_period, terminal_time)
