...
N = 400                                                                                                         # Semi-discretization grid points
...
initial_state = initial_state = [5 * (1 - 2*sin(1.5*pi*x/N)) for x in 1:N]                                                     # Terminal distribution for the PDE

control_1 = deserialize("control_trajectory.dat")
...
uncert_1 = opt_uncert[10, :]  # Extract the first row as the uncertainty sample
