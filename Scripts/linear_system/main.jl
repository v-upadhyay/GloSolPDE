...
initial_state = [10 * (x/100)^2 * (1-(x/100))^3 for x in 1:100]          # Initial distribution for the PDE
terminal_state = [0.0 for _ in 1:100]                                                            # Terminal distribution for the PDE
lambda = 0.01                                                                                                   # Weight for the control cost
gamma = 50                                                                                                    # Weight for the uncertainty cost
...
anneling_trials = 1                   # Number of anneling trials from same initial guess                                                      
max_anneling_iterations = 2           # Number of iterations anneling in each trial
...
objective = [trace[i].value for i in 1:length(trace)]

serialize("objective_iteration.dat", objective)
