...
function internal_minimization(state_matrix, control_matrix, state_matrix_inv, eigen_values, eigen_vectors, num_samples, num_params, terminal_time, uncert_samples, discrete_points)
