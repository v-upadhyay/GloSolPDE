...
terminal_state = [0.0 for x in 1:100]                                                                          # Initial distribution for the PDE
initial_state = [10 * ((x/100)^2) * (1 - x/100)^3 for x in 1:100]                                              # Terminal distribution for the PDE
lambda = 2.0                                                                                                   # Weight for the control cost
...
anneling_trials = 0                   # Number of anneling trials from same initial guess                                                      
...
serialize("objective_iteration_null_dist_2.dat", objective)
