...
function internal_minimization(state_matrix, control_matrix, exp_comp_matrix, control_bounds, num_samples, num_params, terminal_time, uncert, state_dim, initial_state, terminal_state, gamma, lambda, time_samples)
...
dynamics_constraints(model, initial_state, state_matrix, control_matrix, exp_comp_matrix, states_sampled, control_params, uncert, num_samples, num_params)
control_constraints(model, control_params, num_params, control_bounds, time_samples)
...
function control_trajectory(state_matrix, control_matrix, exp_comp_matrix, control_bounds, num_samples, num_params, terminal_time, uncert, state_dim, initial_state, terminal_state, gamma, lambda, time_samples)
